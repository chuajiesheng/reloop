...
int gen_comb_norep_lex_init(size_t *vector, size_t n, size_t k);
int gen_comb_norep_lex_next(size_t *vector, size_t n, size_t k);
...
int gen_perm_rep_lex_init(size_t n);
int gen_perm_rep_lex_next(size_t *vector, size_t n);
