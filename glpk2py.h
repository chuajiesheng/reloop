...
std::vector<double> getMatrixUpper(int scaled);
std::vector<double> getMatrixLower(int scaled);
std::vector<double> getMatrixEqual(int scaled);
std::vector<double> getMatrixUnbound(int scaled);
